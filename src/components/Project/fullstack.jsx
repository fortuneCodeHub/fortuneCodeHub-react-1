                ...
                <div className="glass my-sm-0 my-2">
                    ...
                    <div className="glass-desc">
                        ...
                        <div className="glass-descriptions">
                            {
                                props.available ? 
                                <a href={props.url} target="_blank" rel="noopener noreferrer" className="fu-btn-1 d-flex justify-content-between">
                                    <span className="pe-3">Live <span className="green-spot"></span></span>
                                    <FontAwesomeIcon icon={faExternalLinkAlt} />
                                </a>
                                :
                                <a target="_blank" rel="noopener noreferrer" className="fu-btn-1 d-flex justify-content-between">
                                    <span className="pe-3">Not Live <span className="red-spot"></span></span>
                                </a>
                            }
                            <a onClick={props.displayFullStackSidePanel} className="fu-btn-2" id={props.id} ref={props.btnTwoRefs}>
                                more...
                            </a>
                        </div>  
                    </div>
